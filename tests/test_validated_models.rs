...
fn test_mnist12_cpu() -> Result {
    run_test("mnist-12", 1e-3, Target::CPU, (1, 1))
}

#[test]
fn test_resnet18_cpu() -> Result {
    run_test("resnet18-v2-7", 1e-3, Target::CPU, (1, 1))
}

#[test]
fn test_resnet152_cpu() -> Result {
    run_test("resnet152-v2-7", 1e-3, Target::CPU, (1, 1))
}

#[test]
fn test_yolov4_cpu() -> Result {
    run_test("yolov4", 1e-3, Target::CPU, (1, 1))
}

#[test]
fn test_mnist12_cuda() -> Result {
    run_test("mnist-12", 1e-2, Target::CUDA, (1, 1))
}

#[test]
fn test_resnet18_cuda() -> Result {
    run_test("resnet18-v2-7", 1e-2, Target::CUDA, (1, 1))
}

#[test]
fn test_resnet152_cuda() -> Result {
    run_test("resnet152-v2-7", 1e-1, Target::CUDA, (1, 1))
}

#[test]
fn test_yolov4_cuda() -> Result {
    run_test("yolov4", 1.0, Target::CUDA, (1, 1))
}
