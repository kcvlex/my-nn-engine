...
pub fn create_optimize_passes0(enable_fuse: bool) -> SimplePassManager<SimpleGraphOp> {
...
pub fn create_optimize_passes2(omp_threshold: usize) -> SimplePassManager<SimpleGraphOp> {
